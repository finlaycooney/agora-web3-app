...
>(({ className, ...props }, ref) => (
    <thead
        ref={ref}
        className={cn('cursor-default [&_tr]:border-b [&_tr]:border-border', className)}
        {...props}
    />
));
...
>(({ className, ...props }, ref) => (
    <tbody
        ref={ref}
        className={cn('[&_tr:last-child]:border-0 [&>tr:hover]:bg-hover', className)}
        {...props}
    />
));
...
>(({ className, ...props }, ref) => (
    <th
        ref={ref}
        className={cn(
            'h-10 px-3 text-left align-middle text-[11px] font-semibold tracking-[0.06em] text-muted-foreground uppercase',
            className,
        )}
        {...props}
    />
